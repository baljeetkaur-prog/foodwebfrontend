    ...
    return (
        <nav className="navcontainer">
            <div className="toprow">
                ...
                <div className="rightside">
                    <div className="authlinks">
                        ...
                        <> 
                        <div><Link to="/vieworders" className="nav-item-login">View Placed Orders</Link></div> | 
            ...
            <div className="navlinks">
                <NavLink to="/adminhome" className={({ isActive }) => isActive ? "nav-item active" : "nav-item"}>Admin Home</NavLink>
